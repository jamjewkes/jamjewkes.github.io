...
I'll admit I've never tried Obsidian, so I can't compare it to that. I had a bash at Notion, and was immediately put off. Not my vibe.
...
{{ image(url="/zotero_connector.png", alt="Zotero connector on Firefox adding Transgender Marxism to my library.") }}
...
{ image(url="/zettlr_workspace.png", alt="Zettlr file menu with Open Workspace highlighted.") }}
...
{ image(url="/zettlr_citation.png", alt="Zettlr citation dialogue with one citation highlighted and given extra detail.") }}
